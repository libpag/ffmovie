...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-autodetect --disable-everything --disable-network --enable-small --enable-decoder=mp3 --enable-demuxer=mp3 --enable-muxer=mp3 --enable-protocol=file --target-os=none --arch=x86_32 --cpu=generic --enable-cross-compile --disable-asm --disable-inline-asm --disable-stripping --disable-pthreads --disable-programs --disable-doc --disable-debug --disable-runtime-cpudetect --disable-autodetect --ar=emar --ranlib=emranlib --objcc=emcc --dep-cc=emcc --cc=emcc --cxx=em++ --disable-debug --prefix=/Users/partyhuang/Documents/UGit/ffmovie/third_party/ffmpeg/out/web/wasm
prefix=/Users/partyhuang/Documents/UGit/ffmovie/third_party/ffmpeg/out/web/wasm
...
CC_IDENT=emcc (Emscripten gcc/clang-like replacement + linker emulating GNU ld) 3.1.28-git
ARCH=c
INTRINSICS=none
EXTERN_PREFIX=
CC=emcc
...
CFLAGS=   -std=c11 -fomit-frame-pointer -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Oz -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=   -Qunused-arguments
NVCCFLAGS=--cuda-gpu-arch=sm_30 -O2 -m32 -S -nocudalib -nocudainc --cuda-device-only -Wno-c++11-narrowing -include ./compat/cuda/cuda_runtime.h
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS=  -Wl,-z,noexecstack -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
!HAVE_KCMVIDEOCODECTYPE_HEVCWITHALPHA=yes
...
!CONFIG_PGX_DECODER=yes
!CONFIG_PHOTOCD_DECODER=yes
...
!CONFIG_ADPCM_IMA_MOFLEX_DECODER=yes
...
!CONFIG_AV1_DECODER=yes
!CONFIG_AV1_CUVID_DECODER=yes
!CONFIG_AV1_QSV_DECODER=yes
...
!CONFIG_ADPCM_ARGO_ENCODER=yes
!CONFIG_ADPCM_G722_ENCODER=yes
!CONFIG_ADPCM_G726_ENCODER=yes
!CONFIG_ADPCM_G726LE_ENCODER=yes
!CONFIG_ADPCM_IMA_AMV_ENCODER=yes
!CONFIG_ADPCM_IMA_ALP_ENCODER=yes
!CONFIG_ADPCM_IMA_APM_ENCODER=yes
...
!CONFIG_AV1_D3D11VA_HWACCEL=yes
...
!CONFIG_AUDIOTOOLBOX_OUTDEV=yes
...
!CONFIG_ASUBCUT_FILTER=yes
!CONFIG_ASUPERCUT_FILTER=yes
!CONFIG_ASUPERPASS_FILTER=yes
!CONFIG_ASUPERSTOP_FILTER=yes
...
!CONFIG_COLORCONTRAST_FILTER=yes
!CONFIG_COLORCORRECT_FILTER=yes
!CONFIG_COLORIZE_FILTER=yes
...
!CONFIG_COLORTEMPERATURE_FILTER=yes
...
!CONFIG_MONOCHROME_FILTER=yes
!CONFIG_MPDECIMATE_FILTER=yes
!CONFIG_MSAD_FILTER=yes
...
!CONFIG_TMIDEQUALIZER_FILTER=yes
...
!CONFIG_AAX_DEMUXER=yes
!CONFIG_AC3_DEMUXER=yes
!CONFIG_ACE_DEMUXER=yes
...
!CONFIG_MODS_DEMUXER=yes
!CONFIG_MOFLEX_DEMUXER=yes
...
!CONFIG_SGA_DEMUXER=yes
!CONFIG_SHORTEN_DEMUXER=yes
!CONFIG_SIFF_DEMUXER=yes
!CONFIG_SIMBIOSIS_IMX_DEMUXER=yes
...
!CONFIG_IMAGE_CRI_PIPE_DEMUXER=yes
...
!CONFIG_IMAGE_PGX_PIPE_DEMUXER=yes
!CONFIG_IMAGE_PHOTOCD_PIPE_DEMUXER=yes
...
!CONFIG_IMAGE_XBM_PIPE_DEMUXER=yes
