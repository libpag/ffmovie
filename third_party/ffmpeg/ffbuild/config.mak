...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --enable-cross-compile --arch=arm64 --cc='xcrun -sdk iphonesimulator clang' --disable-all --disable-everything --disable-autodetect --enable-small --enable-avcodec --enable-avformat --enable-swresample --enable-swscale --enable-encoder='aac,mp3' --enable-decoder='aac,mp3,pcm_s16le,pcm_s16be,pcm_f32be,pcm_f32le' --enable-muxer='aac,mp3' --enable-demuxer='aac,mp3,wav' --enable-muxer=mov --enable-muxer=mp4 --enable-decoder='h264,mpeg4' --enable-encoder='h264,mpeg4' --enable-decoder=hevc --enable-demuxer=mov --enable-protocol=file --enable-bsf=h264_mp4toannexb --enable-bsf=hevc_mp4toannexb --enable-libx264 --enable-encoder=libx264 --enable-gpl --disable-debug --extra-cflags='-w -w -mios-simulator-version-min=9.0 -I/Users/a8000/ffmovie/third_party/ffmpeg/../../vendor/libx264/ios/include -arch arm64 -arch arm64 -fvisibility=hidden' --extra-ldflags='-L/Users/a8000/ffmovie/third_party/ffmpeg/../../vendor/libx264/ios/arm64-simulator -arch arm64 -arch arm64' --prefix=/Users/a8000/ffmovie/third_party/ffmpeg/out/ios/arm64-simulator
...
CC_IDENT=Apple clang version 14.0.0 (clang-1400.0.29.202)
ARCH=aarch64
INTRINSICS=neon
EXTERN_PREFIX=_
...
OBJCC=xcrun -sdk iphonesimulator clang
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -DPIC
CFLAGS=  -w -w -mios-simulator-version-min=9.0 -I/Users/a8000/ffmovie/third_party/ffmpeg/../../vendor/libx264/ios/include -arch arm64 -arch arm64 -fvisibility=hidden -std=c11 -Werror=partial-availability -mdynamic-no-pic -fomit-frame-pointer -fPIC -pthread -DX264_API_IMPORTS -I/usr/local/Cellar/x264/r3060/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Oz -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -w -w -mios-simulator-version-min=9.0 -I/Users/a8000/ffmovie/third_party/ffmpeg/../../vendor/libx264/ios/include -arch arm64 -arch arm64 -fvisibility=hidden -mdynamic-no-pic -fPIC -Qunused-arguments
...
DLLTOOL=
WINDRES=windres
DEPWINDRES=xcrun -sdk iphonesimulator clang
DOXYGEN=doxygen
LDFLAGS= -L/Users/a8000/ffmovie/third_party/ffmpeg/../../vendor/libx264/ios/arm64-simulator -arch arm64 -arch arm64  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-pthread -lm -L/usr/local/Cellar/x264/r3060/lib -lx264
